...
//
//    private let model = ExponentialInsulinModel(actionDuration: TimeInterval(minutes: 360), peakActivityTime: TimeInterval(minutes: 75))
//
...
//    }
//
//    func loadDoseFixture(_ resourceName: String, insulinType: InsulinType? = .novolog) -> [FixtureInsulinDose] {
//        let fixture: [JSONDictionary] = loadFixture(resourceName)
//        let dateFormatter = ISO8601DateFormatter.localTimeDate(timeZone: fixtureTimeZone)
//
//        return fixture.compactMap({ (rawValue: JSONDictionary) -> FixtureInsulinDose? in
//            guard let unit = DoseUnit(rawValue: $0["unit"] as! String),
//                  let deliveryType = InsulinDeliveryType(fixtureValue: $0["type"] as! String)
//            else {
//                return nil
//            }
//
//            var dose = FixtureInsulinDose(
//                type: type,
